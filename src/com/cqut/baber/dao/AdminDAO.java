...
public class AdminDAO extends BaseDao
{
	public Page<Map<String,Object>> queryOnePageAdmins(int pageIndex, int pageSize,String realName) throws SQLException, UnsupportedEncodingException
	{
		...
		Page<Map<String,Object>> page = this.queryWithLimit("select count(*) from t_admin"+condition,"select * from t_admin"+condition,new HashMap<String,Object>(), startIndex, pageSize);
		return page;
	}
}