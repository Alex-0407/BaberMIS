...
import com.cqut.genhoo.FrameworkConstant;
import com.cqut.genhoo.SysUtil;
...
public class WebUtil {
     ...
     * @return
     */
    public static String getParamter(HttpServletRequest request,String parameterName){
    	String method  = request.getMethod();
    	String value = request.getParameter(parameterName);
    	if(value!=null && method.toLowerCase().equals("get")){
    		try {
				return new String(value.getBytes(FrameworkConstant.CHARSET_ISO),FrameworkConstant.CHARSET_UTF);
     ...
     * @return
     */
    public static <T> T parseParametersWithBean(HttpServletRequest request,Class<T> t){
