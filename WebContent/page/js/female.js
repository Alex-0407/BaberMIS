function GetBaberInfo_Female() {
	...
	var request = $
			.ajax({
				type : "POST",
				url : baseUrl + "/admin/Baber/GetBaberInfo_Female",
				data : json,
				dataType : "json",
...
function GetBaberInfo_Female_ByPrice() {
	var baseUrl = "http://localhost:8080/BaberMIS/";
	var json = {};
	...
	var request = $
			.ajax({
				type : "POST",
				url : baseUrl + "/admin/Baber/GetBaberInfo_Female_ByPrice",
				data : json,
				dataType : "json",
				success : function(data) {
//					var arr = data.baber;
...
function loadServiceInfo() {
	...
	var request1 = $.ajax({
		type : "POST",
		url : baseUrl + "/admin/Service/GetServiceInfo_Female",
		data : json,
		dataType : "json",
		success : function(data) {
