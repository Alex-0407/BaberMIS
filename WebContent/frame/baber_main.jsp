...
/* alert(session.getAttribute("loginName")); */
</script>
...
<script type="text/javascript">
	$(function() {
		...
		var firstTreeData = [ {
			...
			text : "我的预约",
			attributes : {
				url : "admin/Order/PreOrderIndex"
			}
		}, {
			"id" : 2,
			text : "我的订单",
			attributes : {
				url : "admin/Order/OrderIndex"
			}
		}, {
			"id" : 3,
			text : "未评价订单",
			attributes : {
				url : "admin/Order/EvalateOrderIndex"
			}
		}, {
			"id" : 4,
			text : "已完成订单",
			attributes : {
				url : "admin/Order/FinishOrderIndex"
			}
		}, ];
...
<body class="easyui-layout">
	...
	<div id="accodion"
		...
		<div title="订单管理" iconcls="icon-computer" selected="true"
			style="overflow: auto; padding: 10px;">
			<ul id="firstTree" class="easyui-tree">
			</ul>
		</div>
		<div title="作品管理" iconcls="icon-reload" style="padding: 10px;">
			<ul id="secondTree" class="easyui-tree"></ul>
		</div>
		<div title="业务管理" iconcls="icon-user" style="padding: 10px;">
			<ul id="thirdTree" class="easyui-tree"></ul>
		</div>
		<div title="个人中心" iconcls="icon-key" style="padding: 10px;">
