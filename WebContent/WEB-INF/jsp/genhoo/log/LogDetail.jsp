	...
	<form class="demo form-horizontal" id="detailForm" method="post">
        ...
        <div class="form-item">
            ...
            <div class="form-field">
            	...
            	value="${log.operatorCode}" disabled>
            	<!-- <p class="form-des">描述信息</p> -->
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="form-field">
            	...
            	value="${log.operatorName}" disabled>
            	<!-- <p class="form-des">描述信息</p> -->
            </div>
        </div>
        <div class="form-item">
