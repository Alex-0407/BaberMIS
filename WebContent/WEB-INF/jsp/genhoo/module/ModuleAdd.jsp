...
<body>
	<form method="post" id="addForm" class="myform form1">
		...
		<div class="formItem">
			...
			<div class="formItem_wrapper">
				<div class="formItem_field">
					<input id="name" name="name" type="text" class="easyui-validatebox w2" data-options="required:true,validType:['length[1,30]']"/>
				</div>
			</div>
		</div>
		...
		<div class="formItem">
			...
			<div class="formItem_wrapper">
				<div class="formItem_field">
					<input id="url" name="url" type="text" class="easyui-validatebox w2" data-options="validType:['length[1,200]']"/>
				</div>
			</div>
		</div>
		...
		<div class="formItem row">
			...
			<div class="formItem_wrapper">
				<div class="formItem_field">
					<textarea class="textArea1" name="remark"></textarea>
				</div>
			</div>
		</div>
	</form>
