	...
	<form action="CodeType/edit" method="post" class="baseform" id="addForm">
		...
		<table class="fromGroup">
			<tr>
				...
				<td class="formField">
					<input name="name" value="${codeType.name}" type="text" class="easyui-validatebox" data-options="required:true,validType:['length[1,30]']">
		...
		<table class="fromGroup">
			<tr>
				...
				<td class="formField">
					<input disabled="disabled" type="text" name="code" value="${codeType.code}" class="easyui-validatebox" data-options="required:true,validType:['length[1,30]']">
					<span class="errorInfo"></span>
				</td>
			</tr>
			<tr>
		...
		<table class="fromGroup">
			<tr>
				...
				<td class="formField">
				<textarea rows="5" class="easyui-validatebox w4" name="remark" maxLength = "255" data-options="validType:['length[0,255]']">${codeType.remark}</textarea>
