...
<body>
	<form method="post" id="addForm" class="myform form1">
		<input type="hidden" name="codeTableID" value="${codeTableID}"/>
		<div class="formItem">
			...
			<div class="formItem_wrapper">
				<div class="formItem_field">
					<input id="name" name="name" type="text" value="${name}" class="easyui-validatebox w2" data-options="required:true,validType:['length[1,30]']"/>
				</div>
			</div>
		</div>
