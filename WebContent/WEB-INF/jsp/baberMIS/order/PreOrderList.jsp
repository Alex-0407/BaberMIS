...
<body>
	<div class="topbar">
		<div class="leftrace">
			<span class="location">当前位置：</span> <a href="admin/Order/PreOrderIndex"
				style="color: #333; font-size: 12px;">我的预约</a>
		</div>
		<div class="arrow"></div>
		<div class="btnbar">
			<!-- <a href='javascript:void(0);' onclick='checkAllRow()'>审核</a> -->
		</div>
	</div>
	<div class="queryArea">
...
$(document).ready(function(){
	...
	$('#dataTable').datagrid({
		url:"admin/Order/ajaxSearchPreOrder",
		...
		columns:[[
			...
			{field:'operator',title:'操作',width:2,formatter:function(value,row,index){
				return "<a href='javascript:void(0);' onclick=\"checkRow("+row.orderId+")\">接单</a> | <a href='javascript:void(0);' onclick='uncheckRow("+row.orderId+")'>舍弃</a>" ;
			}}
		]],
...
function checkRow(orderId){
	$.post("admin/Order/checkRow",{orderId:orderId},function(data){
