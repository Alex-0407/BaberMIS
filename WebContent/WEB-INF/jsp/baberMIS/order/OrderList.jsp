...
<body>
	<div class="topbar">
		<div class="leftrace">
			<span class="location">当前位置：</span> <a href="admin/Order/OrderIndex"
				style="color: #333; font-size: 12px;">我的订单</a>
		</div>
		<div class="arrow"></div>
		<div class="btnbar">
...
$(document).ready(function(){
	...
	$('#dataTable').datagrid({
		url:"admin/Order/ajaxSearchOrder",
		...
		columns:[[
			...
			{field:'operator',title:'操作',width:2,formatter:function(value,row,index){
				return "<a href='javascript:void(0);' onclick=\"applyPayRow("+row.orderId+")\">付款提醒</a>" ;
			}}
		]],
...
function applyPayRow(orderId){
	$.post("admin/Order/applyPayRow",{orderId:orderId},function(data){
