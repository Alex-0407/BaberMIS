	...
	<form  method="post" class="baseform" id="addForm">
		...
		<table class="fromGroup">
			<tr>
				...
				<td class="formField">
					<input disabled="disabled" type="text" name="adminRealName" value="${admin.adminRealName}" class="easyui-validatebox" data-options="required:true,validType:['length[1,30]']">
		...
		<table class="fromGroup">
			<tr>
				...
				<td class="formField">
					<input name="adminName" value="${admin.adminName}" type="text" class="easyui-validatebox" data-options="required:true,validType:['length[1,30]']">
					<span class="errorInfo"></span>
				</td>
			</tr>
			<tr>
		...
		<table class="fromGroup">
			<tr>
				...
				<td class="formField">
					<input type="text" name="adminTel" value="${admin.adminTel}" class="easyui-validatebox" data-options="required:true,validType:['length[1,30]']">
					<span class="errorInfo"></span>
				</td>
			</tr>
			<tr>
		...
		<table class="fromGroup">
			<tr>
				...
				<td class="formField">
					<input type="text" name="adminAddress" value="${admin.adminAddress}" class="easyui-validatebox" data-options="required:true,validType:['length[1,30]']">
					<span class="errorInfo"></span>
				</td>
			</tr>
			<tr>
